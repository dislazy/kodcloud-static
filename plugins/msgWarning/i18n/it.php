...
return array(
    ...
    "msgWarning.main.taskClosed"     => "L'attività di notifica non è abilitata. Vuoi abilitarla ora?",
    ...
    "msgWarning.type.feishuDesc"     => "Il servizio di messaggistica Lark richiede l'installazione e la configurazione del plugin di sincronizzazione DingTalk.",
    ...
    "msgWarning.type.ntcFeishu"      => "Messaggi di allodola",
    ...
    "NTC_TYPE_FEISHU"                => "Feishu",
    "NTC_TYPE_FEISHU_DESC"           => "Per inviare messaggi Lark è necessario installare il plugin di sincronizzazione Lark.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "Lo spazio di archiviazione locale è determinato dallo spazio effettivo su disco, mentre lo spazio di archiviazione esterno è determinato dalla capacità configurata.",
