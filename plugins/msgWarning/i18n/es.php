...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "El servicio de mensajería Lark requiere que el complemento de sincronización DingTalk esté instalado y configurado.",
    ...
    "msgWarning.type.ntcFeishu"      => "Mensajes de la alondra",
    ...
    "NTC_TYPE_FEISHU_DESC"           => "Los mensajes de Lark requieren que esté instalado el complemento de sincronización de Lark.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "El almacenamiento local viene determinado por el espacio real en disco, mientras que el almacenamiento de otro tipo viene determinado por la capacidad configurada.",
