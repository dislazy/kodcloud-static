...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "Lark mesajlaşma servisi, DingTalk senkronizasyon eklentisinin kurulu ve yapılandırılmış olmasını gerektirir.",
    ...
    "msgWarning.type.ntcFeishu"      => "Lark Mesajları",
    ...
    "NTC_TYPE_FEISHU_DESC"           => "Lark mesajlarının çalışması için Lark senkronizasyon eklentisinin kurulu olması gerekmektedir.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "Yerel depolama, gerçek disk alanıyla belirlenirken, diğer depolama alanı yapılandırılmış kapasiteyle belirlenir.",
