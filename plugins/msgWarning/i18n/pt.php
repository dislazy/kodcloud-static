...
return array(
    ...
    "msgWarning.main.taskClosed"     => "A tarefa de notificação não está ativada. Deseja ativá-la agora?",
    ...
    "msgWarning.type.feishuDesc"     => "O serviço de mensagens Lark requer que o plugin de sincronização DingTalk esteja instalado e configurado.",
    ...
    "msgWarning.type.ntcFeishu"      => "Mensagens da Lark",
    ...
    "NTC_TYPE_FEISHU_DESC"           => "As mensagens do Lark exigem que o plugin de sincronização do Lark esteja instalado.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "O armazenamento local é determinado pelo espaço em disco real, enquanto outros tipos de armazenamento são determinados pela capacidade configurada.",
