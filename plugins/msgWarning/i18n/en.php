...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "Lark messaging service requires the DingTalk sync plugin to be installed and configured.",
    ...
    "msgWarning.type.ntcFeishu"      => "Lark Messages",
    ...
    "NTC_TYPE_FEISHU_DESC"           => "Lark messages require the Lark sync plugin to be installed.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "Local storage is determined by the actual disk space, while other storage is determined by the configured capacity.",
