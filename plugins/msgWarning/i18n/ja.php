...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "Larkメッセージングサービスを利用するには、DingTalk同期プラグインをインストールして設定する必要があります。",
    ...
    "msgWarning.type.ntcFeishu"      => "ラークメッセージ",
    ...
    "NTC_TYPE_FEISHU"                => "フェイシュ",
    "NTC_TYPE_FEISHU_DESC"           => "Larkメッセージを受信するには、Lark同期プラグインがインストールされている必要があります。",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "ローカルストレージは実際のディスク容量によって決まり、その他のストレージは設定された容量によって決まります。",
