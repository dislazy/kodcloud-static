...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "Le service de messagerie Lark nécessite l'installation et la configuration du plugin de synchronisation DingTalk.",
    ...
    "msgWarning.type.ntcFeishu"      => "Messages de Lark",
    ...
    "NTC_TYPE_FEISHU_DESC"           => "Les messages Lark nécessitent l'installation du plugin de synchronisation Lark.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "Le stockage local est déterminé par l'espace disque réel, tandis que le stockage distant est déterminé par la capacité configurée.",
