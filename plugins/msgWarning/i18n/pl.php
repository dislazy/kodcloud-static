...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "Usługa przesyłania wiadomości Lark wymaga zainstalowania i skonfigurowania wtyczki synchronizującej DingTalk.",
    ...
    "msgWarning.type.ntcFeishu"      => "Wiadomości Lark",
    ...
    "NTC_TYPE_FEISHU"                => "Feiszu",
    "NTC_TYPE_FEISHU_DESC"           => "Do obsługi wiadomości Lark wymagana jest instalacja wtyczki do synchronizacji Lark.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "Wielkość pamięci lokalnej jest określana na podstawie faktycznej przestrzeni dysku, natomiast wielkość pozostałej pamięci jest określana na podstawie skonfigurowanej pojemności.",
