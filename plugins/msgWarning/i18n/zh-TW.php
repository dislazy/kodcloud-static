...
return array(
    ...
    "NTC_TYPE_FEISHU"                => "飛書",
    "NTC_TYPE_FEISHU_DESC"           => "飛書訊息，需安裝【飛書】同步插件",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "本機儲存依磁碟實際空間判斷，其他儲存依配置容量判斷。",
