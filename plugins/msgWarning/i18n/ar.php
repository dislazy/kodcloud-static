...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "تتطلب خدمة المراسلة Lark تثبيت وتكوين إضافة DingTalk sync.",
    ...
    "msgWarning.type.ntcFeishu"      => "رسائل لارك",
    ...
    "NTC_TYPE_FEISHU"                => "فيشو",
    "NTC_TYPE_FEISHU_DESC"           => "تتطلب رسائل Lark تثبيت إضافة Lark sync.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "يتم تحديد مساحة التخزين المحلية من خلال مساحة القرص الفعلية، بينما يتم تحديد مساحة التخزين الأخرى من خلال السعة المُهيأة.",
