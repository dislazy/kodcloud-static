...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "Для работы мессенджера Lark требуется установленный и настроенный плагин синхронизации DingTalk.",
    ...
    "msgWarning.type.ntcFeishu"      => "Сообщения Ларка",
    ...
    "NTC_TYPE_FEISHU"                => "Фейшу",
    "NTC_TYPE_FEISHU_DESC"           => "Для работы с сообщениями Lark требуется установленный плагин синхронизации Lark.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "Объем локального хранилища определяется фактическим объемом дискового пространства, а объем других хранилищ — заданной емкостью.",
