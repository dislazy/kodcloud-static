...
return array(
    ...
    "msgWarning.type.feishuDesc"     => "Lark 메시징 서비스를 이용하려면 DingTalk 동기화 플러그인이 설치 및 구성되어 있어야 합니다.",
    ...
    "msgWarning.type.ntcFeishu"      => "종달새 메시지",
    ...
    "NTC_TYPE_FEISHU"                => "페이슈",
    "NTC_TYPE_FEISHU_DESC"           => "Lark 메시지를 사용하려면 Lark 동기화 플러그인이 설치되어 있어야 합니다.",
    ...
    "msgWarning.sys.storeSizeErrDesc" => "로컬 저장소는 실제 디스크 공간에 따라 결정되는 반면, 기타 저장소는 구성된 용량에 따라 결정됩니다.",
