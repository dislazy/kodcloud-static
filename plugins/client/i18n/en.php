...
return array(
    ...
    "client.meta.setting"            => "<a target='self' link-href='./#admin/server/client' class='kui-btn mt-10 kui-btn-blue'>Setting</a>",
    ...
    "client.down.title"              => "Client/APP Download",
    "client.down.desc"               => "Choose the version suitable for your device to get the latest client experience.",
    "client.down.typePC"             => "Desktop client",
    "client.down.typeApp"            => "Mobile App",
    "client.down.appDown"            => "APP Download",
    ...
    "client.down.manyVers"           => "Several versions, click to view",
    "client.down.clickDown"          => "Click to download",
    "client.down.noApps"             => "If no app is available for download, please contact the administrator!",
    "client.down.chip"               => "Chip",
    "client.down.moreList"           => "There are [0] versions in total. Click to enter the list page.",
    ...
    "client.tfa.totp"                => "Authenticator",
    "client.tfa.totpCode"            => "Dynamic verification code",
    "client.tfa.bindTotp"            => "Binding validator",
    "client.tfa.totpDesc"            => "Please use authenticator apps such as Google or Microsoft to scan the QR code and bind your account.",
    "client.tfa.bindInfoErr"         => "The binding information is incorrect!",
    "client.tfa.tryRefresh"          => "QR code failed to load, please refresh and try again!"
);