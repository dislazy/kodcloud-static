...
return array(
    ...
    "webdav.tips.configErr"          => "Your current server does not support PATH_INFO mode access such as /index.php/index; The Authorization header parameter cannot be omitted; otherwise, login will fail. <a href='http://doc.kodcloud.com/v2/#/help/pathInfo' target='_blank'>Learn how to enable it.</a>",
